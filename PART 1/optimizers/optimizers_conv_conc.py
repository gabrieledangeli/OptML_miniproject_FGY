...
def Dxy_f(alpha,x,y):
    """
    Partial derivative of f(x,y)=alpha*(x^2 - y^2) in dx and then in dy
    """
    return 0

def Dyx_f(alpha,x,y):
    """
    Partial derivative of f(x,y)=alpha*(x^2 - y^2) in dy and then in dx
    """
    return 0

def Dxx_f(alpha,x,y):
    """
    Second partial derivative of f(x,y)=alpha*(x^2 - y^2) in dx
    """
    return 2*alpha

def Dyy_f(alpha,x,y):
    """
    Second partial derivative of f(x,y)=alpha*(x^2 - y^2) in dy
    """
    return -2*alpha
...
def LCGD_step(alpha,x,y,eta):
    """
    LCGD step with parameters eta and alpha.
    eta is the learning rate.
    """
    #update of x
...
def SGA_step(alpha,x,y,eta,gamma):
    """
    SGA step with parameters eta and alpha.
